            ...
            <form action="{{ route('patients.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="mb-3 fw-bold fs-5"><i class="bi bi-geo-alt me-1"></i> {{ __('patients.section_address') }}</h6>
                        <div class="row g-3 mb-4">
                            <div class="col-md-12">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('blood_type') is-invalid @enderror" id="blood_type" name="blood_type" value="{{ old('blood_type') }}" placeholder="{{ __('patients.blood_type_placeholder') }}">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control tagify-input @error('chronic_diseases') is-invalid @enderror @error('chronic_diseases.*') is-invalid @enderror" id="chronic_diseases" name="chronic_diseases" value="{{ old('chronic_diseases') ? (is_array(old('chronic_diseases')) ? implode(',', old('chronic_diseases')) : old('chronic_diseases')) : '' }}" placeholder="{{ __('patients.chronic_diseases_placeholder') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="3" placeholder="{{ __('patients.notes_placeholder') }}">{{ old('notes') }}</textarea>
                            </div>
                        </div>

                        <hr class="my-4">

                        <h6 class="mb-3 fw-bold fs-5"><i class="bi bi-people-fill me-1"></i> {{ __('patients.section_emergency') }}</h6>
