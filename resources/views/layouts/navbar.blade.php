    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-2 modern-menu">
                <li class="nav-item">
                    <a class="nav-link fw-semibold px-2 active" href="#">{{ __('auth.home') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-semibold px-2" href="#">{{ __('auth.how_it_works') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-semibold px-2" href="#">{{ __('auth.features') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-semibold px-2" href="#">{{ __('auth.contact') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-semibold px-2" href="#">{{ __('auth.about') }}</a>
                </li>
            </ul>
